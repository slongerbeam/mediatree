...
struct imx_media_video_dev_ops {
	...
	(*get_next_buf)(struct imx_media_video_dev *vdev, void *job_ctx,
			enum v4l2_buf_type type);
	struct vb2_v4l2_buffer *
	(*remove_next_buf)(struct imx_media_video_dev *vdev, void *job_ctx,
			   enum v4l2_buf_type type);
	void (*buf_done)(struct imx_media_video_dev *vdev, void *job_ctx,
			 enum v4l2_buf_type type, struct vb2_v4l2_buffer *buf,
			 enum vb2_buffer_state status);
	int (*bufs_ready)(struct imx_media_video_dev *vdev, void *job_ctx,
			  enum v4l2_buf_type type);
	void (*device_error)(struct imx_media_video_dev *vdev, void *job_ctx);
};
