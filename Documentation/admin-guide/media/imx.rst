...
This subdev can generate the following event:

- V4L2_EVENT_IMX_FRAME_INTERVAL_ERROR

The user application can subscribe to this event from the ipuX_ic_prpenc
subdev node. This event is generated by the Frame Interval Monitor.

See ref:`imx_api_FIM` for more on the FIM.
...
The user application can subscribe to this event from the ipuX_ic_prpvf
subdev node. This event is generated by the Frame Interval Monitor.
...
from the subdev or from the active capture device interface.
